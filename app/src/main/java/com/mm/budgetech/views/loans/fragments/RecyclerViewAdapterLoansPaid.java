...
public class RecyclerViewAdapterLoansPaid extends RecyclerView.Adapter<RecyclerViewAdapterLoansPaid.ViewHolder> {
   ...
   // ArrayList<String> timeleft = new ArrayList<>();
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_listitems_loans_paid, parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder
    {
      ...
      //  ProgressBar progressBarSave;
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            name = itemView.findViewById(R.id.loan_paid_name);
           // timeleft = itemView.findViewById(R.id.time_left);
            CA = itemView.findViewById(R.id.constraintLayout_paid);
            amount = itemView.findViewById(R.id.loan_paid_Amount);
            date = itemView.findViewById(R.id.reminder_paid);
